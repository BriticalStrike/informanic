...
$yourName = "Brittanee Liukkonen";

$yourEmail = "britliuk@gmail.com";

$requiredFields = "first-name,last-name,email";

$defaultText = "Please submit your information below.";

$errorText = "You didn't enter information into the required fields. Please try again.";

$successText = "You've successfully submitted the form!";
